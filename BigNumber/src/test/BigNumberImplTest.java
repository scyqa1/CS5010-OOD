...
public class BigNumberImplTest {
  ...
  public void getDigitAt() {
    BigNumber bigNumberEqual = new BigNumberImpl("18801");
    assertEquals(8, bigNumberEqual.getDigitAt(3));
    assertEquals(8, bigNumberWithValue.getDigitAt(1));
    assertEquals(9, bigNumberWithValue.getDigitAt(0));
  }
  ...
  @Test
  public void add() {
    BigNumber number = new BigNumberImpl("321");
    BigNumber number2 = new BigNumberImpl("6578");
    assertEquals("6899", number.add(number2).toString());
  }
