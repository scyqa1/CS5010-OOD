...
/**
 * This class represents a non perfect maze. In the non-perfect maze, each cell
 * in the grid also represent a location in the maze, but there can be multiple
 * paths between any two cells.
 */
public class NonPerfectMaze extends PerfectMaze {

	/**
	 * Constructor for building a non perfect maze.
	 *
	 ...
	 *                                  is out of range
	 */
	public NonPerfectMaze(int numberOfRows, int numberOfColumns, int startingPoint, int percentageOfPits,
